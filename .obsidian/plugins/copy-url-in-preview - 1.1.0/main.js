                ...
                image.onload = () => {
                    ...
                    canvas.toBlob((blob) => {
                        ...
                        navigator.clipboard.write([data])
                            .then(new obsidian.Notice("图像复制到剪贴板!", SUCCESS_TIMEOUT));
                    });
                    resolve(true);
                };
                image.onerror = () => {
            ...
            case 'img':
                ...
                switch (Proto) {
                    ...
                    case 'https:':
                        ...
                        break;
                    default:
                        new obsidian.Notice(`${Proto} 协议没有处理程序`);
                        return;
                }
                break;
            case 'a':
                ...
                menu.addItem((item) => item.setIcon("link")
                    ...
                    new obsidian.Notice("链接已复制到剪贴板！", SUCCESS_TIMEOUT);
                }));
                break;
            default:
                new obsidian.Notice("没有此图像类型的处理程序!");
                return;
        }
